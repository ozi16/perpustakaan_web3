    ...
    <div class="container table-anggota">
        <div class="warna">
            <fieldset class='border border-black border-2 p-3'>
                <legend class='float-none w-auto px-2'>Table Anggota</legend>
                <div class="d-flex ms-5">
                    <a href="?pg=tambah-user" class='btn btn-primary me-3'>ADD</a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="?pg=tambah-user&delete=<?php echo $rowUser['id'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini??')" class="btn btn-danger btn-sm"><i data-feather="trash-2"></i></a>
                                        <a href="?pg=tambah-user&edit=<?php echo $rowUser['id'] ?>" class="btn btn-success btn-sm"><i data-feather="edit"></i></a>
                                    </td>
                                </tr>
                            <?php endwhile ?>
                        </tbody>
